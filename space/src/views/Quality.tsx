import type { CalibrationBin, Stats } from "../data/types";
...
export function Quality({ stats, state, onFilter }: Props): JSX.Element {
      ...
      <div className="panels">
        <div className="panel">
          ...
          <p className="panel-note">
            AC1 {fixed(stat.ac1, 3)} (95% {stat.ci_method} bootstrap CI {fixed(stat.lo, 3)}–{fixed(stat.hi, 3)}), κ{" "}
